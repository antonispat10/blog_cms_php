...
//        $post_comment_count = 4;
        ...
        $query = "INSERT INTO posts(post_category_id,post_title,post_user,post_date,post_content,post_tags,post_status)";
        
        //SOSSSS  post_image '{$post_image}'
        
        $query .= "VALUES ('{$post_category_id}','{$post_title}','{$post_user}','{$post_date}','{$post_content}','{$post_tags}','{$post_status}')";
...
-->
    ...
    <div>
        ...
        <textarea class="form-control" name="post_content" id="" cols="10" rows="5"></textarea>
    </div>
